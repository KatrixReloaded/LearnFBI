...
if __name__ == '__main__':
    ...
    parser.add_argument('--alpha', type=float, default=0.05, help='The hyper parameter of perturbation in LearnFBI')
    ...
    args.save_path = '../../learnfbi/checkpoint/{}/seed{}'.format(args.data, seed)
    exp_folder = 'LearnFBI_exp'

    args.save_path = os.path.join(args.save_path, exp_folder)
    if not os.path.exists(args.save_path):
        os.makedirs(args.save_path)
    SAVE_PATH = os.path.join(args.save_path, 'LearnFBI')
    ...
    if log:
        ...
        logfile = open(os.path.join(log_path,'LearnFBI.log'), 'a')
